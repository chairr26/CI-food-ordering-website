...
<body onload="onloadAll()">
    ...
    <div class="container-fluid p-0" style="background: #a0c4ff; height: calc(10vh);">
        <nav id="menu" style="position: fixed;z-index: 999;">
            <input type="checkbox" id="check">
            <label for="check" class="checkbtn">
                <i class="fas fa-bars"></i>
            </label>
            <label class="logo">LAU CAFE</label>
            <ul>

                <li>
                    <a data-toggle="modal" data-target=".orderCart">Keranjang
                ...
                <li><a id="menu_login_button" data-toggle="modal" data-target=".login">nomor meja</a></li>
            ...
            <div id="menu_logout">
                <div id="menu_header22" class="akunnya p-3" style="margin: 0 auto;width: 200px; background: orange; border-radius: 8px; font-family: Helvetica, Arial, sans-serif;padding: 0.5rem;position: absolute;z-index: 999;margin-left: calc(100vw - 250px);margin-top: -25px;display: none;">
                    <p id="hello_user" class="text-white" style="opacity: 0.9"></p>
                    <div id="quanlydon" class="box p-1" style="height: 35px;display: none;">
                        <a href="dashboard.html">
                            <p><i class="fa fa-list-alt text-white mr-3" aria-hidden="true"></i>kelola</p>
                        </a>
                    </div>

                    <div class="box p-1" style="height: 35px">

                        <p onclick="Logout()"><i class="fa fa-sign-out text-white mr-3" aria-hidden="true"></i>Keluar</p>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade bd-example-modal-lg22" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content p-3" style="width: 150%;left: -200px;">
                <p class="font-weight-bold" style="font-size: 110%">Pesanan saya</p>
                ...
                <div data-spy="scroll" data-target="#myScrollspy" data-offset="10" style="height:520px;overflow-y: scroll;padding-top: 5px;padding-right: 10px;">
                    <table class="table table-borderless">
                        ...
                        <thead>
                            <tr>
                                <th scope="col" style="width: 20%;font-size: 115%;">Pelanggan</th>
                                <th scope="col" style="width: 44%;font-size: 115%;" class="text-center">porsi</th>
                                <th scope="col" style="width: 18%;font-size: 115%;" class="text-center">harga</th>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div id="changepass" class=" iconpopup mt-4" style="margin: 0 auto; width: 80%;margin-bottom: 10%;">
                    <p class="text-center mb-3" style="font-weight: bold;margin-bottom: 2%;font-size: 120%">ganti kata</p>
            ...
            <div class="modal-content ">
                ...
                <div class="cart_box" style="width: 100%;margin: auto;">
                    <div class="login_img_box float-left" style="width: 50%;height: 450px;background: pink;">
                        <img src="img_login.jpg" width="100%" height="100%">
                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content ">
                ...
                <div id="checkout_form" class="cart_box pl-5 pt-4 shadow-sm mt-3 pb-4" style="width: 100%;margin: auto;">
                    <p class="ml-2" style="font-size: 130%;font-weight: bold;">Daftar pesanan</p>
                    <div data-spy="scroll" data-target="#myScrollspy" data-offset="10" style="height:340px;overflow-y: scroll;padding-top: 5px;padding-right: 10px;">
                        <table class="table table-borderless">
                            <thead>
                                <tr>
                                    <th scope="col" style="width: 40%;font-size: 115%;">Menu</th>
                                    <th scope="col" style="width: 20%;font-size: 115%;" class="text-center">Jumlah</th>
                                    <th scope="col" style="width: 20%;font-size: 115%;" class="text-center">Harga</th>
                                    <th scope="col" style="width: 20%;font-size: 115%;" class="text-center">Edit</th>
                                </tr>
                            </thead>
                    ...
                    <div class="float-left pl-2" style="width: 30%;">
                        <p class="font-weight-bold mt-2" style="font-size: 115%">Total harga</p>
                    </div>
                    <div class="float-right pr-5" style="width: 30%;">
                        <p id="total_money" class="font-weight-bold float-right mt-2" style="font-size: 115%"> </p>
                    </div>
                    <div style="clear: both;"></div>
                    <div onclick="checkout()" class="btn mr-5 text-white float-right" style="background: #fb9200;">Bayar</div>
                    <div style="clear: both;"></div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#menu_account_login').on('click', function() {
                $('.akunnya').toggleClass('menu_account_show');
            });
    ...
    <script type="text/javascript">
        ...
        if (checkLogin == -1) {
            ...
            document.getElementById("hello_user").innerHTML = "Hallo  " + account[checkLogin].username + " !";
        ...
        function Signup() {
            ...
            if (username != '' && password != '' && Repassword != '' && password == Repassword) {
                ...
                document.getElementById("statusSignup").innerHTML = "masukan nomor meja dan nama";
            }
        }
        ...
        function totalMoney(checkLogin) {
            ...
            document.getElementById("total_money").innerHTML = "Rp " + total_order;
        ...
        function checkorder(id) {
            if (checkLogin == -1) {
                alert("masukan nomor meja dan nama");
            } else {
